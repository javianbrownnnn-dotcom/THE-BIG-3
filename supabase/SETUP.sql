...
-- ============================================================================
-- ---- 0006_team_invites.sql ------------------------------------------------
-- Invite others INTO an existing org: an admin mints a code, the invitee
-- redeems it on sign-up to join. No email/SMTP setup required.
-- ============================================================================
...
-- ============================================================================
-- ---- 0009_shared_briefs.sql -------------------------------------------------
-- Shareable idea briefs: freeze a markdown brief behind an unguessable token
-- so an outside AI (ChatGPT etc.) can fetch it by URL via share-brief.
-- ============================================================================
...
create index if not exists shared_briefs_org_idx on shared_briefs (organization_id, created_at desc);

alter table shared_briefs enable row level security;
drop policy if exists "members read briefs" on shared_briefs;
create policy "members read briefs" on shared_briefs for select to authenticated
  using (is_org_member(organization_id));
drop policy if exists "members create briefs" on shared_briefs;
...
-- ============================================================================
-- ---- 0014_content_studio.sql ------------------------------------------------
-- Modern Ambition Content Studio: gated documentary pipeline + Script Bible.
-- ============================================================================
