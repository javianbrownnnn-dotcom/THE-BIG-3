// Modern Ambition Documentary — the channel DNA, injected into EVERY AI
// surface (studio, ideas, writer, shorts, coach) so the whole system reasons
// from one identity. Client mirror: src/features/studio/personas.ts — keep in
// sync. Enhanced from the creator's own brief; edge stance confirmed as
// "investigate the machine, not the man".
